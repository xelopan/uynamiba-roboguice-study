...
public class ObservesTypeListener implements TypeListener {
    ...
    public ObservesTypeListener(Context context, EventManager eventManager, EventListenerThreadingDecorator observerThreadingDecorator) {
    ...
    protected <I, T> void registerContextObserver(TypeEncounter<I> iTypeEncounter, Method method, Class<T> parameterType, EventThread threadType) {
        ...
        iTypeEncounter.register(new ContextObserverMethodInjector<I, T>(context, eventManager, observerThreadingDecorator,
    ...
    public static class ContextObserverMethodInjector<I, T> implements InjectionListener<I> {
        ...
        public ContextObserverMethodInjector(Context context, EventManager eventManager,
        ...
        public void afterInjection(I i) {
            eventManager.registerObserver(context, event,
